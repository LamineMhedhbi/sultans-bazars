    ...
    { 
		...
		if($i==1){
		 $slide->description[$language['id_lang']] = '<div class="info desc1">
			<p class="title1">The Farm</p>
			<p class="title2">Vegetables & Fruits</p>
			<p class="title3"><span class="des1">100% Organic & Non - Investigationes </span> <span class="des2">demonstraverunt lectores legere</span></p>
